...
<div class="siteWraper">
  ...
  <div class="container">
       ...
       <h1 class="titleheading">Сообщения</h1>
                ...
                <div class="chatCol"><!--Chat user info-->
                    ...
                    <?php if($rec_row):?>
                        ...
                        <div class="col-md-4 col-sm-4">
                        	<a href="<?php echo base_url(); ?>friends/block_friend/<?php echo my_encrypt($rec_row->id); ?>" title="Заблокировать" class="addlist">Заблокировать</a>
                        
                        <?php 
                        if(!$is_freind) {
                        ?>
                        <a href="<?php echo base_url(); ?>friends/send_friend_request/<?php echo my_encrypt($rec_row->id); ?>" title="Отправить запрос в друзья" class="addlist">Добавить в друзья</a>
                        <?php
                        }
                        ?>
                        </div>
                    ...
                    <div class="chatForm">
                        ...
                        <div class="writeBox">
                        <textarea id="message" name="message" class="form-control"></textarea> <input type="button" value="Отправить" class="btn" onclick="sendMessages()" />
                        <div class="clear"></div>
                        </div>
                    </div>
                    </div>
