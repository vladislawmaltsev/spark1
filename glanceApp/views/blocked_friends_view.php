            ...
            <li class="col-md-6">
              ...
              <div class="profileInfo">
                ...
                <p><i class="fa fa-map-marker" aria-hidden="true"></i> <?php echo $row->city;?>, <?php echo $row->country;?></p>                
              	...
              	<a href="<?php echo base_url(); ?>friends/unblock_friend/<?php echo my_encrypt($row->id); ?>" class="chatbtn" title="Accept this Request">Разблокировать</a>
              </div>
