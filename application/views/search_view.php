        	...
        	<div class="col-md-9">            	
				...
				?>
                	<li class="col-md-4">
                    	...
                    	<div class="imgbox"><a href="<?php echo base_url(); ?>profile/<?php echo $searchDetail->username; ?>"><img src="<?php echo ($searchDetail->photo)?base_url().'public/uploads/member_images/thumb_'.$searchDetail->photo:base_url().'public/images/no-image.jpg';?>" alt="<?php echo $searchDetail->name?>" /></a></div>
