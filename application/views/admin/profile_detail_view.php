...
<div class="wrapper row-offcanvas row-offcanvas-left"> 
  ...
  <tr>
    <td width="325" align="center" valign="top"><img src="<?php echo ($row->photo)?base_url().'public/uploads/member_images/'.$row->photo:base_url().'public/images/no-image.jpg';?>" width="300" style=" border:2px solid #666; border-radius:5px; margin:4px;" /></td>
