...
<div class="header">
  <div class="container">
  	<a href="<?php echo base_url(); ?>" class="logo1"><img src="<?php echo base_url();?>glancePublic/images/logo3.png" alt="" /></a>
          ...
          <div class="navbar navbar-default" role="navigation">
            ...
            <div class="navbar-collapse collapse">
              <ul class="nav navbar-nav">
                ...
                <li><a href="<?php echo base_url(); ?>search_profile">Поиск</a></li>
               
                <?php if(!$this->session->userdata('username')) {?>
                <li><a href="<?php echo base_url('register'); ?>">Присоединиться</a></li>
                <li><a href="<?php echo base_url('user/login'); ?>">Войти</a></li>
                <?php } ?>
