...
class Gallery extends CI_Controller {
	...
	public function photos($username,$albumname='')
	{
		...
		//$album_id = $this->gallery_model->get_album_id_by_albumname($albumname);
	...
	public function create_album_name()
	{
		...
		//$real_pathUsername = realpath(APPPATH . '../public/uploads/member_gallery/'.$this->session->userdata('username'));
		$real_pathUsername = './public/uploads/member_gallery/'.$this->session->userdata('username');
		...
		//$real_pathAlbum = realpath(APPPATH . '../public/uploads/member_gallery/'.$this->session->userdata('username').'/'.$album);
		
		$real_pathAlbum = './public/uploads/member_gallery/'.$this->session->userdata('username').'/'.$album;
	...
	public function upload_images() {
		...
		if (!empty($_FILES['photo']['name'])){
			...
			$UsernameDir = './public/uploads/member_gallery/'.$this->session->userdata('username');
			...
			if($album_name != '') {
				...
				$real_pathAlbum = realpath(APPPATH . '../public/uploads/member_gallery/'.$this->session->userdata('username').'/'.$album_name);
