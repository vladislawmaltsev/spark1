            ...
            <li class="col-md-6">
              ...
              <div class="infoProfile">
                ...
                <p><i class="fa fa-map-marker" aria-hidden="true"></i> <?php echo $row->city;?>, <?php echo $row->country;?></p>                
              	<div class="reqbtns"> <a href="<?php echo base_url(); ?>friends/unfavourite/<?php echo my_encrypt($row->id); ?>" class="chatbtn" title="Accept this Request">Убрать из избранных</a></div>
              </div>
