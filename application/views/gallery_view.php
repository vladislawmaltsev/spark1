        ...
        <div class="albumBox">
          ...
          <ul class="photoList">
            <?php
				if($gallery_row):
				 ...
				 if($album_name != '') {
					 ...
					 $thumbNail = base_url().'public/uploads/member_gallery/'.$row->username.'/'.$album_name.'/thumb_'.$galleryDetail->org_photo;
					 
					 $bigImage = base_url().'public/uploads/member_gallery/'.$row->username.'/'.$album_name.'/'.$galleryDetail->org_photo;
					
					//$single_url = base_url().'single/photo/'.$row->username.'/'.$album_name.'/'.$image_id;
					
				 } else {
					 
					 $thumbNail = base_url().'public/uploads/member_gallery/'.$row->username.'/thumb_'.$galleryDetail->org_photo;
					 
					$bigImage = base_url().'public/uploads/member_gallery/'.$row->username.'/'.$galleryDetail->org_photo;
            ...
            <li id="<?php echo $galleryDetail->image_id;?>">
			  ...
			  if($row->username == $this->session->userdata('username')) {
			  ?>
              <a class="remove" title="Delete this Picture" onclick="deleteImage('<?php echo $galleryDetail->image_id;?>')"><img src="<?php echo base_url();?>/public/images/remove.png" alt="Remove Picture" /></a>
              <?php
			  }
			  ?>
           </li>
